...
function RPI_mcp23008Setup(pinBase,i2cAddress)
...
//
// Description
//  This function setups the extension module for the 8-bit MCP23008 I2C GPIO expansion chip.
//
// Examples
...
//  http://wiringpi.com/reference/
    ...
    RPI_commande("mp8#2#"+string(pinBase)+"#"+string(i2cAddress)+"#");
    RPI_send();
endfunction
